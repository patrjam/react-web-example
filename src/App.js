          ...
          <form id="contact-form" action="" onSubmit={this.handleSubmit}>
            ...
            <div className="form-group">
              <label className="checkbox-inline">
                <input name="areas" type="checkbox" value="Analysis" />
                Analysis
              </label>
              <label className="checkbox-inline">
                <input name="areas" type="checkbox" value="Automation" />
                Automation
              </label>
              <label className="checkbox-inline">
                <input name="areas" type="checkbox" value="Development" />
                Development
              </label>
              <label className="checkbox-inline">
                <input name="areas" type="checkbox" value="Training" />
                Training
              </label>
            </div>
